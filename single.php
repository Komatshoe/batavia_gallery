...
<div class="container-fluid maincontainer post-container">
    <div class="container">
        <div class="row">
            <section class="maintext">
<h2 class="body-text">LATEST ARTICLES</h2>	
...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
	...
	<div <?php post_class(); ?>>
		<h3 class="col-sm-7 posttitle title-text" id="post-<?php the_ID(); ?>"><a href="<?php the_permalink() ?>" rel="bookmark"><?php the_title(); ?></a></h3>

		<div class="col-sm-12 postcontent body-text">
			<?php /*?><?php the_post_thumbnail(array(150,150), array ('class' => 'alignright')); ?><?php */?>
			<?php the_content(); ?>
		</div><!--postcomtet-->
						
		<div class="col-sm-7 content-band post-container">
    ...
    <div class="col-sm-7 related-template">
	<h3>RELATED POSTS</h3>
	<ul class="rel-list">
		<?php
    ...
    <div class="col-sm-7 comments-template post-container">
