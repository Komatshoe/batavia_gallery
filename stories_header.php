...
<body>
    <header class="container-fluid stories-sec-hero"<?php if ( get_field(' stories-hero ') ) { echo 'style="background: url(' . get_field(' stories-hero ') . ')"'; } ?>>
...
<?php wp_nav_menu(array(
        ...
        <div class="container-fluid">
            <div class="stories-overlap-1">
                <div class="square-stories">
